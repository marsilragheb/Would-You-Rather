      ...
      <Link to={`/questions/${question.id}`} className='question'>
        <div className='question-total'>
          <div className='question-name' >
             ...
             <span>{users[question.author].name}</span></div>
             
          <img src={users[question.author].avatarURL}
            alt={`Avatar of ${question.author}`} className='avatar'
          />
          ...
          <div className='option'>
            <button className={
                ...
                : answered  ? 'answered'   : ''
              } onClick={(e) => this.handleOptionClicked(1)} >
          ...
          <div className='option opt-offset'>
            <button  className={question.optionTwo.votes.indexOf(authedUser) > -1
